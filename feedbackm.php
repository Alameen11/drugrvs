	...
	<body>
	   <img src="nafdac.jpg"
		...
		<div class="icon">
			...
			<h2 style="font-family: 'Trebuchet MS', sans-serif;">FEEDBACK MENU</h2>
			...
			<table style="text-align: left; padding: 3px; font-family: 'Trebuchet MS', sans-serif;">
				...
				$cn = 1;
				$sql = mysqli_query($link, "SELECT * FROM feedback ORDER BY name ASC");
				while($rows= mysqli_fetch_assoc($sql)){ ?>
				<tr>
					<th><?php echo $cn; ?></th>
					<th><?php echo $rows['drugname']; ?></th>
					<th><?php echo $rows['feedback']; ?></th>
					<th><?php echo $rows['name']; ?></th>
					<th><?php echo date("d.m.Y h:i A", $rows['fbackdate']); ?></th>			
				</tr>
				<?php 
					$cn = $cn + 1;
					} 
